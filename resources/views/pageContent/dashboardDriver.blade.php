...
<div class="grid lg:grid-cols-[260px_1fr] min-h-screen">
    <aside class="bg-ink text-gray-300 p-5 flex lg:flex-col gap-1 overflow-x-auto">
      ...
      <nav class="flex lg:flex-col gap-1 flex-1">
        <a href="dashboard-chauffeur.html" class="flex items-center gap-3 px-3.5 py-3 rounded-lg font-semibold whitespace-nowrap bg-taxi text-ink">📊 <span class="hidden lg:inline">Tableau de bord</span></a>
        ...
        <a href="suivi.html" class="flex items-center gap-3 px-3.5 py-3 rounded-lg font-semibold whitespace-nowrap hover:bg-gray-800 hover:text-white transition">🗺️ <span class="hidden lg:inline">Course active</span></a>
        <a href="historique.html" class="flex items-center gap-3 px-3.5 py-3 rounded-lg font-semibold whitespace-nowrap hover:bg-gray-800 hover:text-white transition">🕓 <span class="hidden lg:inline">Mes courses</span></a>
        ...
        <a href="profil.html" class="flex items-center gap-3 px-3.5 py-3 rounded-lg font-semibold whitespace-nowrap hover:bg-gray-800 hover:text-white transition">🚗 <span class="hidden lg:inline">Mon véhicule</span></a>
        <a href="contact.html" class="flex items-center gap-3 px-3.5 py-3 rounded-lg font-semibold whitespace-nowrap hover:bg-gray-800 hover:text-white transition">🛟 <span class="hidden lg:inline">Support</span></a>
      </nav>
    ...
    <main class="p-7 lg:px-9">
      <div class="flex justify-between items-center mb-7 flex-wrap gap-3">
        <div>
          <h1 class="text-2xl font-extrabold">Bonjour, Marc 🚖</h1>
        ...
        <div class="flex gap-3 items-center">
          ...
          <div class="w-10 h-10 rounded-full bg-taxi grid place-items-center font-extrabold text-ink">MD</div>
        </div>
      </div>

      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-xl p-5 shadow-xs border border-gray-200"><div class="text-gray-500 text-sm">Revenus du jour</div><div class="text-3xl font-extrabold mt-1">186 €</div><div class="text-green-600 text-sm font-semibold mt-1.5">▲ 22%</div></div>
      ...
      <div id="demandes" class="bg-white rounded-2xl p-6 shadow-soft border border-gray-200 border-l-4 border-l-taxi mb-6">
        ...
        <div class="flex justify-between items-center flex-wrap gap-4">
          <div>
            ...
            <div class="flex justify-between gap-6 mt-1"><span class="text-gray-500">💰 Estimation</span><strong class="text-taxi-dark">19,40 € · 18 min</strong></div>
          </div>
          <div class="flex gap-3">
            ...
            <a href="suivi.html" class="inline-flex px-6 py-3 rounded-full font-bold bg-green-600 text-white hover:bg-green-700 transition">Accepter ✓</a>
          </div>
        </div>
      </div>
      ...
      <div id="revenus" class="grid lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-2xl p-7 shadow-soft border border-gray-200">
          ...
          <div class="flex justify-between"><span>Total semaine</span><strong class="text-xl">1 042 €</strong></div>
        </div>
        <div class="bg-white rounded-2xl p-7 shadow-soft border border-gray-200">
          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              ...
              <tbody>
                <tr class="border-t border-gray-200"><td class="px-4 py-3">14:30</td><td class="px-4 py-3">Gare → Aéroport</td><td class="px-4 py-3"><strong>26,00 €</strong></td></tr>
                <tr class="border-t border-gray-200"><td class="px-4 py-3">13:05</td><td class="px-4 py-3">Hôtel Lux → Centre</td><td class="px-4 py-3"><strong>9,60 €</strong></td></tr>
                <tr class="border-t border-gray-200"><td class="px-4 py-3">11:48</td><td class="px-4 py-3">Bureau → Domicile</td><td class="px-4 py-3"><strong>15,00 €</strong></td></tr>
                <tr class="border-t border-gray-200"><td class="px-4 py-3">10:20</td><td class="px-4 py-3">Gare → Hôpital</td><td class="px-4 py-3"><strong>12,30 €</strong></td></tr>
              </tbody>
            </table>
          </div>
        </div>
