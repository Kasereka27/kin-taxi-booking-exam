...
<div class="grid lg:grid-cols-[260px_1fr] min-h-screen">
    <aside class="bg-ink text-gray-300 p-5 flex lg:flex-col gap-1 overflow-x-auto">
      ...
      <nav class="flex lg:flex-col gap-1 flex-1">
        ...
        <a href="{{ route('admin.activity-logs') }}" class="flex items-center gap-3 px-3.5 py-3 rounded-lg font-semibold whitespace-nowrap bg-taxi text-ink">📋 <span class="hidden lg:inline">Journal d'activité</span></a>
      </nav>
