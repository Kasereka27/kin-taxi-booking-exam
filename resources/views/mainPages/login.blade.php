...
<div class="min-h-screen grid lg:grid-cols-2">
    ...
    <main class="flex items-center justify-center p-10">
      <form class="w-full max-w-md bg-white rounded-2xl p-10 shadow-lg2" data-handler="login">
        ...
        <div class="flex justify-between items-center mb-4">
          <label class="flex items-center gap-2 text-sm"><input type="checkbox" /> Se souvenir de moi</label>
